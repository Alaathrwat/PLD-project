...
namespace com.calitha.goldparser
{
    ...
    public class MyParser
    {
        ...
        {
            string message = "Parse error caused by token: '"+args.UnexpectedToken.ToString()+"'" + "inline :" + args.UnexpectedToken.Location.LineNr;
            //todo: Report message to UI?
            lstErrors.Items.Add (message);
            string message2 = "expected token: '" + args.UnexpectedToken.ToString() + "'";
            //todo: Report message to UI?
